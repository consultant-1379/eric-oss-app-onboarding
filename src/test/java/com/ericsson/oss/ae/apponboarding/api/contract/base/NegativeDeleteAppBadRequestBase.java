...
public class NegativeDeleteAppBadRequestBase extends OnboardingBase {
    public void validate() {
        Mockito.doThrow(new AppOnboardingException("Bad Request", HttpStatus.BAD_REQUEST)).when(applicationService).deleteApplication(400l);
    }
}
