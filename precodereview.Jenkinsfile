...
def bob = new BobCommand()
        ...
        .envVars([
                ...
                SERO_ARTIFACTORY_REPO_PASS: '${CREDENTIALS_SERO_ARTIFACTORY_PSW}', //API_TOKEN
                MAVEN_CLI_OPTS            : '${MAVEN_CLI_OPTS}',
                OPEN_API_SPEC_DIRECTORY   : '${OPEN_API_SPEC_DIRECTORY}',
                MARKETPLACE_TOKEN_APP_ONBOARDING: '${MARKETPLACE_TOKEN_APP_ONBOARDING}',
...
pipeline {
    ...
    environment {
        ...
        MARKETPLACE_TOKEN_APP_ONBOARDING = credentials('MARKETPLACE_TOKEN_APP_ONBOARDING')
       ...
       stage('Submodule Sync') {
        ...
        stage('Prepare') {
            steps {
                checkout([$class: 'GitSCM',
                          ...
                          userRemoteConfigs: [
                                  [url: '${GERRIT_MIRROR}/OSS/com.ericsson.oss.ae/eric-oss-app-onboarding']
                          ]
                ])
        ...
        stage('Image') {
            steps {
                ...
                sh "${bob} python-image-ci-internal-repo"
            }
            post {
                always {
...
def modifyBuildDescription() {
    ...
    def CHART_NAME = "eric-oss-app-onboarding"
    def DOCKER_IMAGE_NAME = "eric-oss-app-onboarding"
