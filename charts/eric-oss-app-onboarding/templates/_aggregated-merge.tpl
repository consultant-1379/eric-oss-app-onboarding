...
{{- define "eric-oss-app-onboarding.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-app-onboarding.mergeAnnotations" -}}
  {{- include "eric-oss-app-onboarding.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-oss-app-onboarding.mergeLabels" -}}
  {{- include "eric-oss-app-onboarding.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
